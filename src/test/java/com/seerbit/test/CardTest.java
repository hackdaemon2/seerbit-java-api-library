...
public class CardTest {
    ...
    public void doTestCardOperations() {
        try {
            ...
            client.setPublicKey("public key here");
            client.setPrivateKey("private key here");
            client.setTimeout(20);
            ...
            if (Objects.nonNull(json)) {
                ...
                if (Objects.nonNull(token)) {
                    ...
                    card.setCvv("100");
                    card.setNumber("5061025231593455366");
                    ...
                    cardPayload.put("tranref", "TQ14611X32132PR");
                    ...
                    cardPayload.put("callbackurl", "http://test.surge.sh");
                    cardPayload.put("redirecturl", "http://test2.surge.sh");
